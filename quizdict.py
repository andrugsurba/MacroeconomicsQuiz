...
quizdict={"""An economy that is fully employing all its \
...
"""Assume that land can be used either for
...
"""Increases in real income per capita are made
possible by
...
"""Assume that a country with an open economy
...
"""Which of the following workers is most likely to
...
"""According to the classical model, an increase in
...
"""The diagram above shows aggregate supply
...
"""An increase in which of the following would
...
"""As income level increases from $500 to $1,000,
...
"""In the circular flow diagram of an economy,
...
"""Which of the following would most likely lead
...
"""According to the Keynesian model, equilibrium
...
"""If the Federal Reserve lowers reserve
...
"""Expansionary fiscal policy will be most effective
...
"""Which of the following would increase the value
...
"""A reason for requiring commercial banks to
...
"""The purchase of government bonds from the
...
"""To counteract a recession, the Federal Reserve
could
...
"""According to the Keynesian model, an increase
...
"""Which of the following policies would most
...
"""According to the monetarists, inflation is most
often the result of
...
"""An expansionary fiscal policy would most likely
...
"""Which of the following would result in the
...
"""Which of the following measures might be used
...
"""Which of the following policies is most likely
...
"""If exchange rates are allowed to fluctuate freely
...
"""A revenue-neutral replacement of some portion
...
"""A deficit in the United States trade balance can
be described as
...
"""Problems faced by all economic systems include
...
"""An increase in which of the following will cause
...
"""If the exchange rate changes from 1 United
...
"""An increase in which of the following is most
...
"""Assume that last year the consumer price index
...
"""The natural rate of unemployment can be
...
"""A fully anticipated expansionary fiscal policy
...
"""If the nominal gross domestic product is
...
"""Which of the following best describes crowding
out?
...
"""Suppose that the economy is operating at
...
"""If the Federal Reserve suddenly increases the
...
"""The United States federal government budget
...
"""Using the same amount of resources, Betaland
...
"""If the required reserve ratio is 0.20 and the
...
"""The table above shows the T-account entries of
...
"""Hyperinflation is usually associated with which
of the following?
...
"""According to the short-run Phillips curve, which
...
"""Which of the following is true if there is a
...
"""An increase in national saving will cause the real
...
"""To raise its long-run rate of economic growth, a
...
"""With a constant money supply, an increase in
...
"""Which of the following policies will most
...
"""Assume that an economy produces only two
...
"""Assuming that the expected inflation rate is
...
"""A bank has demand deposits of $100,000 and
...
"""Which of the following will lower inflationary
expectations?
...
"""An increase in national saving will affect the
...
"""Which of the following policies will most likely
...
"""The real interest rate for a consumer loan is
...
"""Which of the following groups is most likely to
...
"""Assume that there are only two countries—Eland
...
"""If both the demand for and the supply of coffee
...
"""Which of the following would cause a country’s
...
"""Which of the following is true about economic
growth?
...
"""The M1 measure of the money supply primarily
...
"""If a country’s consumer price index was 200 last
...
"""Gross domestic product is defined as which of
the following?
...
"""If central banks in Asia reduce the supply of
...
"""Which of the following policy actions could the
...
"""Jamal lost his computer programming job when
...
"""Which of the following will decrease gross
