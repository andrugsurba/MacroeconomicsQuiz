...
def main(): 
    ...
    #Iterates over keys in the dictionary
        ...
        def restart():
        #I made this into a function since this code is used again later 
